...
export default function EventDetailsPage() {
  ...
  return (
    <main className="flex flex-col w-full min-h-screen text-zinc-900">
      <div className=" flex h-56 bg-indigo-600">
      ...
      <div className="flex flex-col items-center justify-center rounded-t-2xl -mt-12 bg-zinc-50 w-full min-h-screen">
        <div className="p-4 rounded-t-2xl min-h-screen">
          <div className="w-full bg-indigo-100 rounded-xl p-5 border border-zinc-100">
